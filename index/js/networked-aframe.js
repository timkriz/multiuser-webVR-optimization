...
! function(e) {
    ...
    l.options = i, l.utils = o, l.log = new s, l.schemas = new r, l.version = "0.7.1", l.adapters = new u;
    var h = new a,
        d = new c(h);
                    ...
                    t.on("connect", (function() {
                        ...
                        if (e.myRoomJoinTime = n, NAF.log.write("Successfully joined room", e.room, "at server time", n), e.sendAudio) {
                            navigator.mediaDevices.getUserMedia({
                                ...
                                e.storeAudioStream(e.myId, t), e.connectSuccess(e.myId), t.getTracks().forEach((function(n) {
                                    Object.keys(e.peers).forEach((function(i) {
                                        e.peers[i].pc.addTrack(n, t)
                                    }))
                                }))
                            })).catch((function(t) {
                                NAF.log.error(t), console.error("Microphone is disabled due to lack of permissions"), e.sendAudio = !1, e.connectSuccess(e.myId)
                            }))
            ...
            value: function(e) {
                ...
                var n = this,
                    ...
                    o = function(e) {
                        ...
                        s.setDatachannelListeners(n.openListener, n.closedListener, n.messageListener, n.trackListener.bind(n)), n.peers[o] = s
                    };
                for (var s in e) o(s);
                this.occupantListener(e)
            }
    ...
    AFRAME.registerSystem("networked", {
        ...
        networkUpdate: function(e) {
            if (!(e.lastOwnerTime < this.lastOwnerTime || this.lastOwnerTime === e.lastOwnerTime && this.data.owner > e.owner) && void 0 !== this.data) {
